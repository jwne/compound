...
public abstract class CompoundTypeIO {
	
	public abstract void write(CompoundOutput out, Object val) throws Exception;
	public abstract Object read(CompoundInput in) throws Exception;
